    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
          ...
          {form.watch("songId") && (
            <div className="space-y-4 p-4 bg-purple-50 dark:bg-purple-950/20 rounded-lg border border-purple-200 dark:border-purple-800 cursor-auto">
              ...
              <div className="space-y-3 bg-white dark:bg-gray-900 p-4 rounded-md border border-purple-100 dark:border-purple-900 cursor-auto">
                <p className="text-sm font-medium text-purple-800 dark:text-purple-300">Edit song details below</p>
                
                <div className="grid grid-cols-2 gap-4 cursor-auto">
                  <div className="cursor-auto">
                    <Label htmlFor="songTitle" className="cursor-default">Title</Label>
                    <Input
                      id="songTitle"
                  ...
                  <div className="cursor-auto">
                    <Label htmlFor="songAlbum" className="cursor-default">Album</Label>
                    <Input
                      id="songAlbum"
                ...
                <div className="grid grid-cols-2 gap-4 cursor-auto">
                  <div className="cursor-auto">
                    <Label htmlFor="songPublishingOwnership" className="cursor-default">Publishing Ownership (%)</Label>
                    <Input
                  ...
                  <div className="cursor-auto">
                    <Label htmlFor="songMasterOwnership" className="cursor-default">Label Recording Ownership (%)</Label>
                    <Input
